	...
	public static void main(String[] args) {
		...
		if (login.equalsIgnoreCase("admin") && senha.equalsIgnoreCase("admin")) {
			...
			for (int qtd = 0; qtd <= 5; qtd++) {
				...
				String CPF = JOptionPane.showInputDialog("Qual o CPFdo aluno ?");
				String NMAE = JOptionPane.showInputDialog("Qual o nome da mae do aluno ?");
				String NPAI = JOptionPane.showInputDialog("Qual o nome do pai do aluno ?");
				String DMATR = JOptionPane.showInputDialog("Qual a data de matricula ?");
				...
				aluno1.setDataNascimento(DNASC);
				aluno1.setRegitroGeral(RG);
				aluno1.setNumeroCPF(CPF);
				aluno1.setNomeMae(NMAE);
				aluno1.setNomePai(NPAI);
				aluno1.setDataMatricula(DMATR);
